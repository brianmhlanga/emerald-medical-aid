...
const useAuthStore = defineStore("auth", {
  ...
  actions: {
    ...
    async clientMe() {
      const applicantData = useCookie("user").value;
      console.log(useCookie("applicant").value);
      const token = useCookie("token").value;
      useCookie("applicant_id").value;
      useCookie("permissions").value || [];
      console.log(token);
      this.applicantData = applicantData;
      this.applicant_id = applicantData == null ? void 0 : applicantData.id;
    ...
    async me() {
      ...
      const token = useCookie("token").value;
      const employeeID = useCookie("employee_id").value;
      useCookie("employeeDepartmentID").value;
      useCookie("permissions").value || [];
      console.log(token);
      this.userData = userData;
      this.user_id = userData == null ? void 0 : userData.id;
    ...
    async getPersonalInfo() {
      var _a;
      var data = JSON.stringify({
        "sid": (_a = this == null ? void 0 : this.userData) == null ? void 0 : _a.id
      });
      const config = {
        method: "post",
...
//# sourceMappingURL=auth-EG7XnNR-.mjs.map
