...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderStyle, ssrRenderComponent, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(valid_id) === false) {
        _push(ssrRenderComponent(_component_InlineMessage, { severity: "warn" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`ID Number must be in the format (15-225668V75)`);
            } else {
              return [
      ...
      _push(`<small style="${ssrRenderStyle({ "color": "red" })}">Required</small></div><div class="field mb-4 col-6"><label for="nickname2" class="font-medium text-900">Physical Address</label>`);
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<small style="${ssrRenderStyle({ "color": "red" })}"${_scopeId}>Required</small></div></div><div${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", {
                ...
                createVNode("div", { class: "border-top-1 surface-border pt-3 flex" }, [
                  ...
                  createVNode("button", {
                    disabled: !unref(dependent_first_name) || !unref(dependent_last_name) || !unref(selected_dependent_gender) || !unref(selected_relationship_to_principal) || unref(dependent_valid_id) === false || !unref(dependent_id_number),
      ...
      _push(`</div><div class="surface-border border-top-1 opacity-50 mb-3 col-12"></div><div class="col-12">`);
      _push(ssrRenderComponent(_component_Button, {
        loading: unref(loading),
        onClick: ($event) => submitApplication(),
        label: "Send Application",
        icon: "pi pi-file",
        disabled: !unref(first_name) || !unref(last_name) || !unref(selected_titles) || !unref(date_of_birth) || !unref(id_number) || unref(valid_id) === false || !unref(selected_gender) || unref(cell_validation).isValid === false || !unref(physical_address) || !unref(selected_marital_status)
      }, null, _parent));
...
//# sourceMappingURL=individuals-68XtF7RJ.mjs.map
