...
const _imports_1 = "" + publicAssetsURL("images/civil.jpg");
const _imports_2 = "" + publicAssetsURL("images/individuals.jpg");
const _sfc_main$1 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_Button = resolveComponent("Button");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "surface-section px-4 py-8 md:px-6 lg:px-8" }, _attrs))}><div class="parent-container"><img width="180"${ssrRenderAttr("src", _imports_0)} alt="Logo"></div><div class="flex flex-wrap"><div class="surface-section px-4 py-8 md:px-6 lg:px-8"><div class="text-center text-900 text-5xl font-bold mb-5">Available Packages</div><div class="grid nogutter"><div class="col-12 lg:col-6 p-6"><div class="custom-shadow-2 border-round h-full surface-card"><img${ssrRenderAttr("src", _imports_1)} alt="Image" class="block w-full border-round-top"><div class="p-4"><div class="text-xl text-900 font-medium mb-3 line-height-3">Civil Servants</div><div class="line-height-3 mb-3 text-700 mb-4">Cater specifically to civil servants, providing health coverage tailored for government employees.</div>`);
  ...
  _push(`</div></div></div><div class="col-12 lg:col-6 p-6"><div class="custom-shadow-2 border-round h-full surface-card"><img${ssrRenderAttr("src", _imports_2)} alt="Image" class="block w-full border-round-top"><div class="p-4"><div class="text-xl text-900 font-medium mb-3 line-height-3">Individuals</div><div class="line-height-3 mb-3 text-700 mb-4">Tailored to provide comprehensive health coverage and additional benefits to individual members.</div>`);
  _push(ssrRenderComponent(_component_Button, {
...
//# sourceMappingURL=index-N5-T1gj5.mjs.map
